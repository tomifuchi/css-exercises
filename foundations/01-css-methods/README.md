...
### Self Check
- Did you use all three methods of adding CSS to an HTML file? Yep.
- Did you properly link the external CSS file in the HTML file? Yep, If not then it would be broken.
